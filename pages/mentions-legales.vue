  ...
  <div class="bck">
    <div class="content_mentions">
      ...
      <div class="block_content">
        ...
        <p>
          <strong>Propriétaire :</strong> La Taqueria - Quai de paludate, 33000 Bordeaux.
        </p>
        <p><strong>Responsable publication : Stéphane Eclache</strong> </p>
        <p>
          <strong>Hébergeur :</strong> O2 Switch – 222 Boulevard Gustave
          Flaubert – 63000 Clermont-Ferrand – France.
        </p>
        <p><strong>Développement et Webdesign :</strong> <a href="https://rouxnicolas.fr" target="_blank"> Nicolas ROUX</a></p>
        <p><strong>Charte graphique:</strong> <a href="https://noemiepulido-graphiste.com/" target="_blank"> Noémie PULIDO</a></p>
      </div>
      <div class="block_content">
        <h3>
        ...
        <hr />
        <p>
          L’utilisation du site www.lataqueria-bordeaux.fr implique l’acceptation pleine
          ...
          complétées à tout moment, les utilisateurs du site www.lataqueria-bordeaux.fr
        ...
        <p>
          Le site www.lataqueria-bordeaux.fr est mis à jour régulièrement par Stéphane Eclache. De la même façon, les mentions légales peuvent être modifiées à
      ...
      <div class="block_content">
        ...
        <hr />
        <p>
          Le site www.lataqueria-bordeaux.fr a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
        </p>
        <p>
           s’efforce de fournir des informations aussi précises que
          possible sur le www.lataqueria-bordeaux.fr . Toutefois, il ne pourra être
        ...
        <p>
          Tous les informations indiquées sur le site www.lataqueria-bordeaux.fr.fr sont
          données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site www.lataqueria-bordeaux.fr
      ...
      <div class="block_content">
        ...
        <p>
          ...
          www.lataqueria-bordeaux.fr, et résultant soit de l’utilisation d’un matériel
        ...
        <p>
          ...
          chance) consécutifs à l’utilisation du site www.lataqueria-bordeaux.fr.
        </p>
        <p>
      ...
      <div class="block_content">
        ...
        <p>
          A l’occasion de l’utilisation du site www.lataqueria-bordeaux.fr , peuvent
          êtres recueillies : l’URL des liens par l’intermédiaire desquels
          l’utilisateur a accédé au site www.lataqueia-bordeaux.fr, le fournisseur
        ...
        <p>
          ...
          services proposés par le site www.lataqueria-bordeaux.fr. L’utilisateur
          ...
          l’utilisateur du site www.lataqueria-bordeaux.fr l’obligation ou non de
        ...
        <p>
          ...
          www.lataqueria-bordeaux.fr n’est publiée à l’insu de l’utilisateur, échangée,
          ...
          du site www.lataqueria-bordeaux.fr.
        </p>
        <p>
      ...
      <div class="block_content">
        ...
        <hr />
        <p>
          Le site www.lataqueria-bordeaux.fr contient un certain nombre de liens
        ...
        <p>
          La navigation sur le site www.lataqueria-bordeaux.fr est susceptible de
        ...
        <p>
          <strong>Sous Internet Explorer :</strong> onglet outil (pictogramme en
        ...
        <p>
          <strong>Sous Safari :</strong> Cliquez en haut à droite du navigateur
        ...
        <p>
          <strong>Sous Chrome :</strong> Cliquez en haut à droite du navigateur
      ...
      <div class="block_content">
        ...
        <hr />
        <p>
          Tout litige en relation avec l’utilisation du site www.lataqueria-bordeaux.fr
      ...
      <div class="block_content">
        ...
        <p>
          ...
          libertés. <br />Loi n° 2004-575 du 21 juin 2004 pour la confiance dans
